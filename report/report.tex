...
This means we cannot use the classic Rate Monotonic algorithm \cite{rm-dm}, only offset-based and the traditional holistic analysis \cite{holistic-analysis}. The reason for this lies in the fact that Rate Monotonic assumes independent tasks, but the interrupt transaction is composed by an ISR executed by Interrupt\_FP\_Server, followed by the interrupt handler in External Event Server, which is activated by the former and thus it depends on it for its activation.

As final note, as of the time of writing, offset-based analysis fallbacks to holistic analysis with EDF processing resources \cite{mast-readme}.

\section{FPS analysis}

Assuming sporadic tasks as periodic with period equal to the minimum interarrival time, which is the worst case, the hyperperiod is $LCM(1, 3, 5) = 15s$. The hyperperiod of a set of tasks is least common multiple of all periods. To check that the system will meet the deadlines, it suffices to run it for at least the first hyperperiod amount of time.

\begin{table}[!htbp]
  \centering
  \begin{tabular}{lllll}
    \toprule
    Transaction & Worst case response time (s) & Slack & Worst blocking time (s) & Jitter \\
    \midrule
    rp\_transaction & 0.020440  & 2470.0\% &  2.000E-06 & 0.001107 \\
    ocp\_transaction & 0.026598 & 10776.6\% & 1.000E-06 & 0.019472 \\
    alr\_transaction & 0.030201 & 26600.8\% & 0.00 & 0.026619 \\
    event\_queue\_interrupt ISR & 1.100E-05 & >=100000.0\% & 1.000E-06 & 4.844E-06 \\
    event\_queue\_interrupt EES & 3.818E-05 & >=100000.0\% & 1.000E-06 & 2.202E-05 \\
    \bottomrule
  \end{tabular}
...
The system slack is 2401.2\% and total utilisation 2.58\%.
...
A first analysis suggests that smaller values can be used as ceilings for \texttt{request\_buffer} and \texttt{activation\_log}. This is expected since the two values are the highest priorities of the tasks Regular\_Producer and External\_Event\_Server respectively. We modify the implementation ceilings accordingly.

We then increase the Whetstone workload of factor 24 in the first three transactions, since 2477.0\% is the smallest slack of the three of them. It correponds to how much the execution time of all event responses can be increased while preserving system schedulability \cite{practitioner-growth}.

We leave the Event Queue interrupt intact. The new results are as follows:
...
\begin{table}[!htbp]
   ...
   \begin{tabular}{lllll}
     ...
     Transaction & Worst case response time (s) & Slack & Worst blocking time (s) & Jitter \\
     \midrule
     rp\_transaction & 0.485492  & 2.73\% &  2.000E-06 & 0.002895 \\
     ocp\_transaction & 0.662663 & 76.95\% & 1.000E-06 & 0.485181 \\
     alr\_transaction & 0.751713 & 277.34\% & 0.00 & 0.663011 \\
     event\_queue\_interrupt ISR & 1.100E-05 & >=100000.0\% & 1.000E-06 & 4.844E-06 \\
     event\_queue\_interrupt EES & 3.818E-05 & >=100000.0\% & 1.000E-06 & 2.202E-05 \\
     \bottomrule
   \end{tabular}
...
The system slack is 3.21\% and total utilisation 55.15\%. Blocking times have not changed because protected operations are same as before.

The slack value of Regular\_Producer is very low so we can leave it as it is, otherwise the MAST analysis will assert as not schedulable because of the transaction having a WCET just slightly larger than the deadline. We proceed instead to increase the workload of On\_Call\_Producer and Activation\_Log\_Reader.
...
\begin{table}[!htbp]
   ...
   \begin{tabular}{lllll}
     ...
     Transaction & Worst case response time (s) & Slack & Worst blocking time (s) & Jitter \\
     \midrule
     rp\_transaction & 0.485492  & 0.390625\% &  2.000E-06 & 0.002895 \\
     ocp\_transaction & 0.798045 & 0.390625\% & 1.000E-06 & 0.485704 \\
     alr\_transaction & 0.954736 & 28.13\% & 0.00 & 0.798650 \\
     event\_queue\_interrupt ISR & 1.100E-05 & 17737.1\% & 1.000E-06 & 4.844E-06 \\
     event\_queue\_interrupt EES & 3.818E-05 & 17737.1\% & 1.000E-06 & 2.202E-05 \\
     \bottomrule
   \end{tabular}
   \caption{Holistic analysis results for FPS}
   \label{tab:holistic-fps}
...
The system slack is 0.390187\% and total utilisation 60.10\%. We now increase workload of Activation\_Log\_Reader.
...
\begin{table}[!htbp]
   ...
   \begin{tabular}{lllll}
     ...
     Transaction & Worst case response time (s) & Slack & Worst blocking time (s) & Jitter \\
     \midrule
     rp\_transaction & 0.485492  & 0.0\% &  2.000E-06 & 0.002895 \\
     ocp\_transaction & 0.798045 & 0.390625\% & 1.000E-06 & 0.485704 \\
     alr\_transaction & 0.997460 & 0.390625\% & 0.00 & 0.798650 \\
     event\_queue\_interrupt ISR & 1.100E-05 & 13963.3\% & 1.000E-06 & 4.844E-06 \\
     event\_queue\_interrupt EES & 3.818E-05 & 13963.3\% & 1.000E-06 & 2.202E-05 \\
     \bottomrule
   \end{tabular}
   \caption{Holistic analysis results for FPS}
   \label{tab:holistic-fps}
...
The system slack is 0.390187\% and total utilisation 61.51\%.

...
We provide a further proof of the equivalence between FPS and EDF scheduling by observing the execution metrics. We have enhanced both runtimes with a custom instrumentation to provide valuable execution information such as deadline misses, execution counts, preemptions and release jitters.

\begin{table}[!htbp]
   \centering
   \begin{tabular}{llllll}
    \toprule
    Task & Deadline misses & Executions & Preemptions & Min Release Jitter & Max Release Jitter \\
    \midrule
    Regular\_Producer & 0 & 19 &  0 & 0.001053733 &  0.001505544 \\
    On\_Call\_Producer & 0 & 6 &  0 & 0.000033067 &  0.000034194 \\
    Activation\_Log\_Reader & 0 & 6 &  0 & 0.000032178 &  0.000033528 \\
    External\_Event\_Server & 0 & 4 &  0 & N/A & N/A \\
    \toprule
   \end{tabular}
...
Table \ref{tab:instrumentation-fps-050} provides the results for the FPS execution with the system under maximum utilisation, until 19 executions of Regular\_Producer. Release jitter is skipped for External\_Event\_Server since it's always the task with highest priority.
...
\begin{table}[!htbp]
   ...
   \begin{tabular}{llllll}
    ...
    Task & Deadline misses & Executions & Preemptions & Min Release Jitter & Max Release Jitter \\
    \midrule
    Regular\_Producer & 0 & 19 & 0 & 0.001056517 & 0.001313233 \\
    On\_Call\_Producer & 0 & 6 & 0 & 0.000029317 & 0.000030450 \\
    Activation\_Log\_Reader & 0 & 6 & 0 & 0.000031033 & 0.000032261 \\
    External\_Event\_Server & 0 & 4 & 0 & N/A & N/A \\
    \toprule
   \end{tabular}
...
\begin{table}[!htbp]
   ...
   \begin{tabular}{llllll}
    ...
    Task & Deadline misses & Executions & Preemptions & Min Release Jitter & Max Release Jitter \\
    \midrule
    Regular\_Producer & 19 & 19 & 0 &  0.001053628 &  0.001547378 \\
    On\_Call\_Producer & 6 & 6 & 6 &  0.000042828 &  0.000044033 \\
    Activation\_Log\_Reader & 6 & 6 & 6 &  0.021249300 &  0.021490806 \\
    \toprule
   \end{tabular}
...
\begin{table}[!htbp]
   ...
   \begin{tabular}{llllll}
    ...
    Task & Deadline misses & Executions & Preemptions & Min Release Jitter & Max Release Jitter \\
    \midrule
   Regular\_Producer & 19 & 19 & 0 &  0.001056522 &  0.019908256 \\
   On\_Call\_Producer & 0 & 6 & 0 & 0.000038889 &  0.000040044 \\
   Activation\_Log\_Reader & 6 & 6 & 6 &  0.000040717 &  0.000041944 \\
    \toprule
   \end{tabular}
...
\begin{table}[!htbp]
   ...
   \begin{tabular}{llllll}
    ...
    Task & Deadline misses & Executions & Preemptions & Min Release Jitter & Max Release Jitter \\
    \midrule
    Regular\_Producer & 19 & 19 & 0 &  0.001056522 &  0.237997678 \\
    On\_Call\_Producer & 5 & 6 & 5 &  0.000039511 &  0.000040083 \\
    Activation\_Log\_Reader & 6 & 6 & 3 &  0.000041700 &  1.105315111 \\
    \toprule
   \end{tabular}
...
\begin{table}[!htbp]
   ...
   \begin{tabular}{llllll}
    ...
    Task & Deadline misses & Executions & Preemptions & Min Release Jitter & Max Release Jitter \\
    \midrule
     Regular\_Producer & 19 & 19 & 0 & 0.001053700 & 0.001516400 \\
     On\_Call\_Producer & 6 & 6 & 6 & 0.000041728 & 0.000042822 \\
     Activation\_Log\_Reader & 3 & 3 & 12 & 0.243860556 & 1.219195511 \\
    \toprule
   \end{tabular}
...
With our previous overruning case, the rescaling factor would be $U = (0.7/1 + 0.5/3 + 0.5/3) \approx 1.0\bar{3}$. According the to theorem, the tasks are executing with average periods $\tilde{T}_{RP} = T_{RP}*U = 1.0\bar{3} * 1 = 1.0\bar{3}$ and $\tilde{T}_{OCP} = \tilde{T}_{ALR} = 1.0\bar{3} * 3 = 3.1$. Indeed, it can be verified with the help of Figure \ref{timeline-overload-edf-pattern} that in the repeated interval of 3.1 seconds, RP executes 3 times ($3.1/1.0\bar{3} = 3$), whereas OCP and ALR execute once respectively ($3.1/3.1 = 1$).

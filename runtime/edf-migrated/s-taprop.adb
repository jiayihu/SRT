...
package body System.Task_Primitives.Operations is
   ...
   is
      ...
      dead_idle : constant System.BB.Deadlines.Relative_Deadline :=
   ...
   begin
      ...
      Tasking.Initialize_ATCB
        (Idle'Access, Null_Address, Any_Priority (0),
         Environment_Task.Common.Base_Relative_Deadline, CPU_Id,

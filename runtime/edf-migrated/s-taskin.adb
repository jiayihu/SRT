...
package body System.Tasking is
   ...
   procedure Initialize is
      Base_Priority : constant Any_Priority := System.Any_Priority (1);
...
--        end if;
      ...
      Initialize_ATCB
        (null, Null_Address, Base_Priority, Base_Relative_Deadline, CPU'First,
   ...
   procedure Set_Priority (Pri : Integer) is
   begin
      Self.Common.Base_Priority := Pri;
   end Set_Priority;

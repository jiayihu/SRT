...
package body System.Tasking.Restricted.Stages is
   ...
   procedure Create_Restricted_Task
     (Priority             : Integer;
      ...
      Created_Task         : Task_Id)
   is
      Base_Priority        : constant System.Any_Priority := Any_Priority (2);
   ...
   begin
      ...
      Initialize_ATCB
        (State, Discriminants, Base_Priority, Base_Relative_Deadline, Base_CPU,
         Task_Info, Stack_Address, Size,
      ...
      if Partition_Elaboration_Policy = 'S' then
         ...
         Create_Restricted_Task_Sequential
           (Priority, Stack_Address, Stack_Size,
            Sec_Stack_Address, Sec_Stack_Size, Task_Info, CPU, State,
   ...
   begin
      --  Relative_Deadline,
      Create_Restricted_Task (Priority, Stack_Address, Stack_Size,
                              Sec_Stack_Address, Sec_Stack_Size,
                              Task_Info, CPU, State, Discriminants,
                              Created_Task);

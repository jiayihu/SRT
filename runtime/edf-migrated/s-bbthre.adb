...
package body System.BB.Threads is
   ...
   begin
      ...
      Id.Base_Priority   := Any_Priority (1);
      Id.Active_Priority := Any_Priority (1);
...
--                              --  Absolute_Deadline'Last;
   ...
   is
      ...
      Idle_Relative_Deadline : constant System.BB.Deadlines.Relative_Deadline
        := System.BB.Time.Milliseconds (2000000000);
   begin
      Initialize_Thread
        (Idle_Thread, Null_Address, Null_Address,
         Idle_Relative_Deadline, CPU_Id,
   ...
   begin
      ...
      Initialize_Thread
        (Id, Code, Arg, Relative_Deadline, Base_CPU,
